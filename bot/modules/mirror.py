    ...
    def onUploadComplete(self, link: str, size, files, folders, typ):
        if self.isLeech:
            ...
            if self.message.chat.type == 'private':
                ...
                try:
                    app.sendMessage(chat_id=self.message.from_user.id, text=msg1, parse_mode=ParseMode.HTML)
                except Exception as e:
                    LOGGER.warning(e)
            if LOGS_CHATS:
                try:
